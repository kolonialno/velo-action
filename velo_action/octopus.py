...
class Octopus:
    def __init__(
        self, api_key: str = None, server: str = None, base_space_id: str = "Spaces-1"
    ) -> None:
        ...
        self.octa_env_vars = {
            "OCTOPUS_CLI_API_KEY": self.api_key,
            "OCTOPUS_CLI_SERVER": self.server,
        }
        ...
        try:
            ...
            raise Exception(
                f"Could not connect to Octopus deploy server at {self.server}"
            )
